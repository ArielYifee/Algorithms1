...
public class GlassBall {
    ...
    public static int solution(int amountOfBalls, int strogOfTheBall, int index, int end) {
        ...
        if (amountOfBalls >= logBase2(end - index)) {
            ...
            return solution(amountOfBalls, strogOfTheBall, index, end);
        }
    }
    ...
    public static void main(String[] args) {
        System.out.println(solution(4, 100, 0, building.length - 1));
    }
}